...
namespace ReqnrollProject1.Features
{
    ...
    public partial class DeleteFeature : object, Xunit.IClassFixture<DeleteFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Delete", null, global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line 8
    await testRunner.GivenAsync("Un cliente con cédula \"1726791642\" existe en la base de datos", ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
#line hidden
#line 9
    await testRunner.WhenAsync("Elimino el cliente con cédula \"1726791642\" de la base de datos", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 10
    await testRunner.ThenAsync("El cliente con cédula \"1726791642\" ya no debe existir en la base de datos", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
